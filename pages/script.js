...
const BATCH_SIZE = 10; 
const MIN_LOADER_VISIBLE_MS = 250;  const cashfree = window.Cashfree ? window.Cashfree({ mode: "production" }) : null;
...
if (list.length === 0) {
grid.innerHTML =  ` <div class="no-components">   <h3>No components available</h3>   <button id="viewAllBtn">View all components</button>   </div>  `;
